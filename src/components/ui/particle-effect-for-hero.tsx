...
export const AntiGravityCanvas: React.FC = () => {
    ...
    return (
        <div
            ref={containerRef}
            className="absolute inset-0 z-0 overflow-hidden bg-black cursor-crosshair min-h-[inherit]"
    ...
    return (
        <nav className="absolute top-0 left-0 w-full z-20 flex justify-between items-center p-6 md:p-8 pointer-events-none">
            <div className="flex items-center space-x-2 pointer-events-auto">
                ...
                <span className="text-white font-medium tracking-wide text-lg">Quiz Master</span>
            </div>
            <div className="hidden md:flex space-x-8 text-sm font-medium text-white/70 pointer-events-auto">
            ...
            <button className="text-white/80 hover:text-white transition-colors pointer-events-auto">
                <Info size={24} />
            </button>
        </nav>
    )
